...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      setError("root", {
        message:
          err instanceof Error ? err.message : "Credenciales incorrectas o error de red.",
      });
    } finally {
      setLoading(false);
    }
          ...
          <div className="rounded-2xl bg-white/95 backdrop-blur-sm shadow-2xl p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={loading}
                    className="w-full h-12 rounded-xl border border-gray-300 pl-10 pr-4 outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-900/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    disabled={loading}
                    className="w-full h-12 rounded-xl border border-gray-300 pl-10 pr-12 outline-none focus:border-blue-900 focus:ring-2 focus:ring-blue-900/10 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full h-12 rounded-xl bg-red-600 text-white font-bold shadow-lg hover:bg-red-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <span className="flex items-center justify-center">
                    <svg
