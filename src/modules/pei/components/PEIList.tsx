...
import {
  DynamicTable,
  ColumnConfig,
} from "@/shared/components/common/DynamicTable";
import PEIForm from "@/modules/pei/components/PeiForm"; // Asumo que el formulario sigue existiendo
  ...
  const peiColumns: ColumnConfig<PEI>[] = [
    ...
    },
    {
      ...
      render: (item) => (
        <span
          className={
            item.ejecucion > 0 ? "text-green-600 font-medium" : "text-gray-400"
          }
        >
