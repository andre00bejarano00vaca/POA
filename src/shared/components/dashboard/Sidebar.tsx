  ...
  return (
    <>
                        ...
                        return (
                          <li key={j}>
                            <Link
                              ...
                              className={`flex items-center gap-3 pl-12 py-2 text-sm hover:text-white transition-colors ${
                                subActive
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 bg-blue-900 p-2 text-white rounded-lg z-[60]"
      >
        {sidebar ? <IoMdClose /> : <RiAlignRight />}
      </button>
      {sidebar && (
